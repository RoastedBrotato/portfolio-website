      ...
      <div className="contact-shell">
        <div className="contact-card">
          ...
          <div className="contact-actions">
            <a className="contact-primary" href="mailto:waleedajaz1996@gmail.com">Start a conversation</a>
            <div className="contact-links">
              <a href="mailto:waleedajaz1996@gmail.com">waleedajaz1996@gmail.com</a>
              <a href="https://github.com/RoastedBrotato" target="_blank" rel="noopener noreferrer">GitHub</a>
              <a href="https://linkedin.com/in/waleedajaz" target="_blank" rel="noopener noreferrer">LinkedIn</a>
            </div>
          ...
          <div className="contact-brand-lockup" aria-hidden="true">
            <span>W</span>
